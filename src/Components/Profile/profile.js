            ...
            <Grid container component="main" className="root">
                ...
                <Grid item xs={12} sm={8} md={5} className="loginrightcomponent" elevation={6} square>
                    ...
                    <div style={paper}>
                        ...
                        <img className="avatar" alt="" src={this.state.photoUrl ? this.state.photoUrl : "https://firebasestorage.googleapis.com/v0/b/project-chat-8768e.appspot.com/o/nopic.jpg?alt=media&token=fec32a00-e2cf-488a-a0a2-8e1c1a07dbb3"} />
