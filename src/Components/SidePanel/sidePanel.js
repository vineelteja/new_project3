...
class SidePanel extends React.Component {
    ...
    searchHandler = (e) => {
        let searchQuery = e.target.value.toLowerCase(),
            filteredContacts = this.searchUsers.filter((el) => {
        ...
        return (
            <div id="frame">
                <div id="sidepanel">
                    <div id="profile">
                        <div class="wrap">
                            <img id="profile-img" src={this.currentUserPhoto ? this.currentUserPhoto : "https://firebasestorage.googleapis.com/v0/b/project-chat-8768e.appspot.com/o/nopic.jpg?alt=media&token=fec32a00-e2cf-488a-a0a2-8e1c1a07dbb3"} class="online" alt="" />
                                        ...
                                        (
                                            ...
                                            >
                                                <div class='wrap'>
                                                    ...
                                                    <img alt="" src={item.URL ? item.URL : "https://firebasestorage.googleapis.com/v0/b/project-chat-8768e.appspot.com/o/nopic.jpg?alt=media&token=fec32a00-e2cf-488a-a0a2-8e1c1a07dbb3"}></img>
                                                    <div class="meta">
